...
public class OptionBuilder {
	...
	public static String buildUserCommandOptions(Set<Attribute> attributes, boolean isAdd){
		...
		for (Attribute attr : attributes){
        	...
        	if (attr.is(SchemaAccountAttribute.PUBLIC_KEY.getName())){
        		continue;
        	}
        	...
        	if (!Utilities.checkOccurence(accountAttr.getOccurence(), attr.getValue())){
        		throw new IllegalArgumentException("Attempt to add multiple values to the single valued attribute " + attr.getName());
        	}
	...
	public static String buildGroupCommandOptions(Set<Attribute> attributes, boolean isAdd){
		...
		for (Attribute attr : attributes){
        	...
        	if (!Utilities.checkOccurence(groupAttr.getOccurence(), attr.getValue())){
        		throw new IllegalArgumentException("Attempt to add multiple values to the single value attribute " + attr.getName());
        	}
